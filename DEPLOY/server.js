...
app.prepare()
  .then(() => {
    // Use http.createServer so Node.js can listen on EITHER:
    //   - A Windows named pipe path set by iisnode (e.g. \\.\pipe\...)
    //   - A regular TCP port number (e.g. 3000) for local dev
