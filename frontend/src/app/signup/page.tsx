      ...
      <div className="z-10 w-full max-w-md px-4">
        <div className="bg-[#0e0e0e]/80 border border-white/5 rounded-2xl p-8 md:p-10 shadow-2xl backdrop-blur-xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mt-3 mb-1">Create your account</h1>
            <p className="text-zinc-500 text-sm">Join the Nexus Forum community</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4" noValidate>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                autoComplete="new-password"
                className={`w-full bg-[#141414] border rounded-xl px-4 py-3 text-white text-sm outline-none focus:ring-2 transition-all placeholder:text-zinc-600 ${
                  confirmPassword && password !== confirmPassword
                    ? "border-red-500/40 focus:ring-red-500/10 focus:border-red-500/40"
                    : "border-white/5 focus:border-purple-500/40 focus:ring-purple-500/10"
                }`}
              />
              {confirmPassword && password !== confirmPassword && (
